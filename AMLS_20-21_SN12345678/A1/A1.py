...
def load_test_data(path):
    ...
    del test_labels2[0]
    del test_labels2[3]
    test_labels2.columns = ['img_name', 'gender']
    ...
    for gender in test_data['gender']:
        test_labels = np.append(test_labels, gender)
...
def mainA1(path1, path2):
    ...
    del data_labels2[0]
    del data_labels2[3]
    data_labels2.columns = ['img_name', 'gender']
    ...
    for gender in training_data['gender']:
        training_labels = np.append(training_labels, gender)
    validation_labels = np.array([])
    for gender in validation_data['gender']:
        validation_labels = np.append(validation_labels, gender)
    ...
    model = Sequential()
    model.add(layers.Conv2D(12, 3, activation='relu', input_shape=(IMG_HEIGHT, IMG_WIDTH, 1)))
    ...
    #test_set2, test_labels2 = load_test_data("../Datasets/dataset_AMLS_20-21/celeba_test/")
...
if __name__ == "__main__":
    mainA1("../Datasets/celeba/", "../Datasets/celeba_test/")
